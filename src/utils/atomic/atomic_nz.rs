...
impl AtomicNzU64 {
  ...
  #[inline]
  pub(crate) fn from_nonzero(value: NonZeroU64) -> Self {
  ...
  #[inline]
  pub(crate) fn load(&self, order: Ordering) -> NonZeroU64 {
  ...
  #[inline]
  pub(crate) fn fetch_add(&self, value: u64, ordering: Ordering) -> NonZeroU64 {
    'fetch_add: loop {
